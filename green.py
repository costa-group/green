...
def run_gasol(instr, contract_name, block_id, output_file, csv_file, dep_information = {}, useless_info = False):
    statistics_rows = []
    instructions = instr
    ...
    for old_block in blocks:
        print(timeout)
        asm_block, _, statistics_csv = gasol_main.optimize_asm_block_asm_format(old_block, timeout, parsed_args, dep_information, useless_info)
        ...
        eq, reason = gasol_main.compare_asm_block_asm_format(old_block, asm_block, parsed_args,dep_information, useless_info)
    ...
    if parsed_args.backend:
        ...
        if dep_information != {}:
            ...
            has_useless = useless_info and (dep_information.get_useless_info() != [])
    ...
    for c in opt_blocks:
        ...
        for b in blocks:
            ...
            if not args.gasol_mem_opt:
                ...
                run_gasol(instructions_as_plain_text,c,b,output_file,csv_file,blocks[b],args.useless_info)
