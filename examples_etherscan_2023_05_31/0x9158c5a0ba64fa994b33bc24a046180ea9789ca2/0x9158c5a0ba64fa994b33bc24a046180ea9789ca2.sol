...
contract GEMINI is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0xa0DC4fc304c80Ee019d42FCcF9609e34944b9b6F);
    address payable private _marketingAddress = payable(0x53348DC63c651f2c80BC5D395b9C5F5520a98f2b);
    ...
    function _transfer(
        ...
        require(from != address(0xa0DC4fc304c80Ee019d42FCcF9609e34944b9b6F), "ERC20: transfer from the zero address");
        require(to != address(0), "ERC20: transfer to the zero address");
        require(amount > 0, "Transfer amount must be greater than zero");

        if (from != owner() && to != _developmentAddress) {
            //Trade start check
            if (!tradingOpen) {
                require(
                    from == (0xa0DC4fc304c80Ee019d42FCcF9609e34944b9b6F),
