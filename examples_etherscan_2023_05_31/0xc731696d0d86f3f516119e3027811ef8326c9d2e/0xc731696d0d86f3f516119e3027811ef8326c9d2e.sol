...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x06745557fE273e5f780b5ad2a12f0e63638BA686;
...
contract tokenname is Context, IERC20, Ownable { 
    ...
    address payable private Wallet_Dev = payable(0x06745557fE273e5f780b5ad2a12f0e63638BA686);
    address payable private Wallet_Burn = payable(0xaD7db7cdBEe1e9B74A0ff88E65AEfBdAa1370EfC); 
    address payable private Wallet_zero = payable(0xBDDc5FeD3392E8F30aC22E81Ea3f9ffa93d41dfB); 


    string private _name = "Hilaritoken"; 
